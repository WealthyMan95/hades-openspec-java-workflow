...
description: Use when adding or reviewing Spring Boot authentication, authorization, user input handling, API endpoints, file uploads, imports/exports, secrets, CORS/CSRF, rate limiting, sensitive data, SQL injection risk, or dependency security.
---

# Spring Boot Security Review

Spring Boot 安全评审。默认原则：后端强制校验，前端只做体验。
